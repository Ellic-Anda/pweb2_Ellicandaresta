        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{route('home')}}">SIKEKWARMA - Sistem Informasi Kegiatan Kwartir Ranting Maos</a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a>Level: {{Auth::user()->hak_akses}}</a></li>
